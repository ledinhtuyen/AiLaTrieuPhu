...
QT_MOC_LITERAL(1, 10, 16), // "switchToNotLogin"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 19) // "on_startBtn_clicked"

    },
    "MenuStart\0switchToNotLogin\0\0"
    "on_startBtn_clicked"
};
...
void MenuStart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switchToNotLogin(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuStart::switchToNotLogin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MenuStart::switchToNotLogin()
{
